    ...
    return (
        <div className="w-full min-h-screen py-2 px-4">
            <div className="flex justify-between items-center mb-4 pt-2">
                <p className="text-2xl font-semibold text-[#3f2a2a] tracking-tight">Supplier {isEditMode ? 'Edit' : 'Detail'}</p>
                <div className="text-[12px] text-gray-500 font-medium">EMM Master / Supplier / {isEditMode ? 'Edit' : 'Detail'}</div>
            </div>
